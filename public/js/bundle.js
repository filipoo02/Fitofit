...
exports.formatDate = exports.replacePlChars = exports.checkAddressFormat = void 0;
...
var checkAddressFormat = function checkAddressFormat(address) {
  var _address$trim$split = address.trim().split(","),
      _address$trim$split2 = _slicedToArray(_address$trim$split, 3),
      street = _address$trim$split2[0],
      city = _address$trim$split2[1],
      country = _address$trim$split2[2];
...
var replacePlChars = function replacePlChars(word) {
  // ą, ć, ę, ł, ń, ó, ś, ź, ż
  var arrayChars = ["a", "c", "e", "l", "n", "o", "s", "z", "z"];
  var arrayPlChars = ["ą", "ć", "ę", "ł", " ń", "ó", "ś", "ź", "ż"];
  var newWord = word.trim().toLowerCase();
  arrayPlChars.forEach(function (letter, index) {
...
exports.replacePlChars = replacePlChars;
...
var formatDate = function formatDate(_ref) {
  var dataInput = _ref.dataInput,
      _ref$returnTime = _ref.returnTime,
      returnTime = _ref$returnTime === void 0 ? false : _ref$returnTime,
      _ref$returnDate = _ref.returnDate,
      returnDate = _ref$returnDate === void 0 ? false : _ref$returnDate,
      _ref$returnBoth = _ref.returnBoth,
      returnBoth = _ref$returnBoth === void 0 ? true : _ref$returnBoth,
      _ref$inputIsDateForma = _ref.inputIsDateFormat,
      inputIsDateFormat = _ref$inputIsDateForma === void 0 ? false : _ref$inputIsDateForma,
      _ref$minusTwoHours = _ref.minusTwoHours,
      minusTwoHours = _ref$minusTwoHours === void 0 ? false : _ref$minusTwoHours;
  var milisec = 0;
  ...
  var miliSeconds = data.getMilliseconds();
  var time = "".concat(hours, ":").concat(minutes, ":").concat(seconds, ":").concat(miliSeconds);
  if (returnBoth) return "".concat(date, ", ").concat(time);
  if (returnTime) return "".concat(time);
  if (returnDate) return "".concat(date);
};
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"getDistance.js":[function(require,module,exports) {
"use strict";
...
var getDistance = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(address1, address2) {
    var results;
...
},{"axios":"../../node_modules/axios/index.js"}],"insertWalk.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.insertNewWalk = void 0;
...
var insertNewWalk = /*#__PURE__*/function () {
  ...
  return function insertNewWalk(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.insertNewWalk = insertNewWalk;
},{"axios":"../../node_modules/axios/index.js"}],"modalStats.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.modalStats = void 0;
...
var modalStatsBtn = document.querySelector(".modal-stats");

var modalStats = function modalStats() {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              table = "<table><tr>\n          <th>Distance (km)</th>\n          <th>Date</th>\n          </tr>"; // formatDate({ dataInput: new Date(v.dateOfActivity), returnDate: true })
              ...
              return (0, _axios.default)({
                ...
                val.data.results.forEach(function (v) {
                  table += "<tr><td>".concat(v.distance, "</td><td>").concat(v.dateOfActivity, "</td></tr>");
                });
              });
  ...
  modalStatsBtn.addEventListener("click", function (e) {
    createTable().then(function (v) {
      showModal();
    });
  });
...
var _insertWalk = require("./insertWalk");

var _modalStats = require("./modalStats");
...
var submitBtn = document.querySelector(".submit-addrs-btn");
var characters = "[&/\\#+!@^()$~%.'\":*?<>{}]";
var detailsBtn = document.querySelector(".modal-stats");
var distanceValue = document.querySelector(".distance-value");
(0, _utils.replacePlChars)("ą, ć, ę, ł, ń, ó, ś, ź, ż");
if (detailsBtn) (0, _modalStats.modalStats)();
console.log(distanceValue.textContent);

var inputAdresses = function inputAdresses() {
  var address1 = document.querySelector("#address1");
  var address2 = document.querySelector("#address2");
  return [(0, _utils.replacePlChars)(address1.value), (0, _utils.replacePlChars)(address2.value)];
};

var resetFieldAddrs = function resetFieldAddrs() {
  var address1 = document.querySelector("#address1");
  var address2 = document.querySelector("#address2");
  address1.value = "";
  address2.value = "";
...
submitBtn.addEventListener("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var _inputAdresses, _inputAdresses2, address1Value, address2Value;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _inputAdresses = inputAdresses(), _inputAdresses2 = _slicedToArray(_inputAdresses, 2), address1Value = _inputAdresses2[0], address2Value = _inputAdresses2[1];

            if (!(!(0, _utils.checkAddressFormat)(address1Value) || !(0, _utils.checkAddressFormat)(address2Value))) {
              _context.next = 6;
              break;
            }

            e.preventDefault();
            (0, _alert.showAlert)("error", "Please provide right address format!");
            _context.next = 12;
            break;
          ...
          case 6:
            ...
            (0, _alert.showAlert)("loading", "Loading...");
            _context.next = 12;
            return (0, _getDistance.getDistance)(address1Value, address2Value).then(function (result) {
              (0, _alert.hideAlert)();

              if (result.status === 200) {
                resetFieldAddrs();
                var distance = result.data.results.distance;
                var objToInsert = {
                  distance: result.data.results.distance,
                  dateOfActivity: new Date()
                };
                (0, _insertWalk.insertNewWalk)(objToInsert).then(function (res) {
                  if (res.status === 200) {
                    (0, _alert.showAlert)("success", "".concat(distance, " km walk was added!"));
                    distanceValue.textContent = distanceValue.textContent * 1 + distance * 1;
                  } else {
