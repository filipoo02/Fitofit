...
},{}],"modalStats.js":[function(require,module,exports) {
"use strict";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              result.data.weeklyDistance.forEach(function (v) {
                table += "<tr><td>".concat(v.distance, "</td><td>").concat(formatDate({
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./utils":"utils.js"}],"insertWalk.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (_results.data.status === "success") {
              (0, _alert.showAlert)("success", _results.data.message);
            }
...
var addrCalcForm = document.querySelector(".form-calc-dist");
var characters = "[&\\#+!@^()$~=-_%.';\":*?<>{}]";
